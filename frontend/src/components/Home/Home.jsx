      ...
      <div className="leading-normal tracking-normal text-white gradient">
         <>
            ...
            <div className="pt-20 px-10">
               <div className="containe px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
                  {/*Left Col*/}
                  <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                     ...
                     <p className="leading-normal text-2xl mb-8">
                        Record and Track All of Your desired Habits and see
                        changes in 30 days!
                     </p>
                     <Link
                        to={"/habit/new"}
                  ...
                  <div className="flex flex-wrap">
                     <div className="w-5/6 sm:w-1/2 p-6">
                        ...
                        <p className="text-gray-600 mb-8">
                           With HabitTrackr, adding and monitoring your habits
                           has never been easier. Simply input your habits into
                           the app, set your daily targets, and start marking
                           them off as you complete them. Our streamlined
                           interface ensures that managing your habits is
                           effortless, allowing you to focus more on your goals
                  ...
                  <div className="flex flex-wrap flex-col-reverse sm:flex-row">
                     ...
                     <div className="w-full sm:w-1/2 p-6 mt-6">
                        <div className="align-middle">
                           ...
                           <p className="text-gray-600 mb-8">
                              Gain valuable insights into your habits and
                              progress with HabitTrackr's interactive charts.
                              See how consistently you're completing your habits
                              over time, identify trends, and celebrate your
                              successes. Our visualizations make it easy to stay
                              motivated and make informed decisions about your
               ...
               <div className="container mx-auto flex flex-wrap pt-4 pb-12">
                  ...
                  <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                     <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                        <Link
                           to={"/"}
                           className="flex flex-wrap no-underline hover:no-underline pt-4"
                        >
                           <p className="w-full text-gray-600 text-xs md:text-sm px-6">
                              Add Habit
                           </p>
                           <div className="w-full font-bold text-xl text-gray-800 px-6 mb-2">
                              Sync Across Devices
                           </div>
                           <p className="text-gray-800 text-base px-6 mb-5">
                              HabitTrackr keeps your habits in sync across all
                              your devices. Access your habit data from your
                              smartphone, tablet, or computer, ensuring that you
                              can track your progress wherever life takes you.
                           </p>
                        </Link>
                     </div>
                  ...
                  <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                     <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                        ...
                        >
                           ...
                           <div className="w-full font-bold text-xl text-gray-800 px-6 mb-2">
                              Treack Your Progress
                           </div>
                           <p className="text-gray-800 text-base px-6 mb-5">
                              See how consistently you're completing your habits
                              over time, identify trends, and celebrate your
                              successes, stay motivated and make informed
                              decisions about your habits moving forward.
                           </p>
                        </Link>
                     </div>
                     <div className="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
                  ...
                  <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                     <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                        ...
                        >
                           ...
                           <div className="w-full font-bold text-xl text-gray-800 px-6 mb-2">
                              Edit, Delete Your habits
                           </div>
                           <p className="text-gray-800 text-base px-6 mb-5">
                              Simply input your habits into the app, set your
                              daily targets, and start marking them off as you
                              complete them. Our streamlined interface allowing
                              you to focus more on your goals and less on the
                              logistics.
                           </p>
                        </Link>
                     </div>
                     ...
                     <div className="flex flex-col w-5/6 lg:w-1/3 mx-auto lg:mx-0 rounded-lg bg-white mt-4 sm:-mt-6 shadow-lg z-10">
                        <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                           ...
                           <ul className="w-full text-center text-base font-bold">
                              ...
                              <li className="border-b py-4">Accountability</li>
                              <li className="border-b py-4">
                                 Goal Progression
                              </li>
                              <li className="border-b py-4">
            ...
            <section className="container mx-auto text-center py-6 mb-12">
               ...
               <h3 className="my-4 text-3xl mb-8 leading-tight">
