...
//   return (
//     <div className='bg-white  p-3 '   style={{ backgroundImage: `url(${assets.Bg})` }}>
//      <a href="/intro"><img className='text-black bg-white' src={assets.back} alt="" /> </a>
//       <div className='flex justify-center mt-5'><h2 className='text-2xl text-gray-700 header'>Welcome Back!</h2>
//       </div>
...
//       <p className='text-[10px] text-blue-300 font-extrabold header'>OR LOG IN WITH EMAIL</p>
//       </div>
//       <div className='flex flex-col mt-9 space-y-5'>
//        <input className='bg-gray-200 p-3 rounded-xl header'  type="text" placeholder='Email' />
//        <input className='bg-gray-200 p-3 rounded-xl header'  type="text" placeholder='password' />     
//        </div>
//        <div className='flex justify-center mt-5'>
//        <button className=' bg-customPurple header p-3 text-white font-extrabold rounded-3xl w-full'>LOG IN</button>
//        </div>
//        <div className='flex justify-center mt-2'>
//        <p className='text-[12px] header '>Forgot password?</p>
//        </div>
//        <div className='flex justify-center mt-10'>
//      <p className='text-[14px] header'>DON'T HAVE AN ACCOUNT? </p><a href='/signup' className='text-[14px] header text-customPurple'>_SIGN UP</a>
//      </div>
//     </div>
//   )
// }
